    ...
    'menu' => [
        ...
        [
            ...
            'children' => [
                ...
                ['key' => 'implant_companies', 'route' => 'settings.implant-companies.index', 'permission' => 'implant_company.view'],
                ['key' => 'insertion_approaches', 'route' => 'settings.insertion-approaches.index', 'permission' => 'insertion_approach.view'],
