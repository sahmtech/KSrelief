...
@section('content')
<x-page-header
    :title="__('settings.ct_finding_options.show_title')"
    :subtitle="__('settings.ct_finding_options.show_subtitle')"
    :breadcrumbs="[
...
>
    <x-slot:actions>
        @can('ct_finding_option.update')<a href="{{ route('settings.ct-finding-options.edit', $option) }}" class="btn btn-primary btn-sm"><i class="ti ti-pencil me-1"></i> {{ __('settings.actions.edit') }}</a>@endcan
    </x-slot:actions>
</x-page-header>
<div class="row g-3">
    <div class="col-lg-8">
